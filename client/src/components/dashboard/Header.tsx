...
export function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full bg-indigo-50/90 dark:bg-indigo-950/80 backdrop-blur-xl supports-[backdrop-filter]:bg-indigo-50/70 dark:supports-[backdrop-filter]:bg-indigo-950/60 border-b border-indigo-100/50 dark:border-indigo-900/50 h-16 flex items-center px-4 md:px-8 shadow-md before:absolute before:inset-x-0 before:top-0 before:h-[3px] before:bg-gradient-to-r before:from-primary before:via-indigo-500 before:to-primary">
